# --------------------------------------------------------
#to generate all pseudo labels in training dataset
# --------------------------------------------------------
...
def run(fasterRCNN, val_load, epoch):
    fasterRCNN.eval()
    ...
    for idx, blob in enumerate(val_load):
      ...
      preds_path = os.path.join(args.save_dir, args.dataset, args.net, 'all_train_detection')
...
if __name__ == '__main__':
  ...
  train_data = CityDataSet(args.dataset, 'detection')
  print('train_data: ', len(train_data))

  dataloader = DataLoader.loader(train_data, batch_size=args.batch_size, num_workers=1)
  print('train_loader: ', len(dataloader))
